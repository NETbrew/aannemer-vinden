				...
				<div className=" flex lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
					<div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
						<Link
							href="/#"
							aria-current="page"
							className="flex gap-2 justify-center md:justify-start items-center text-customWhite"
						>
							<Image
								src={logo}
						...
						<p className="mt-3 text-sm text-customWhite">
					...
					<div className="flex-grow flex flex-wrap justify-center -mb-10 md:mt-0 mt-10 text-center">
						<div className="lg:w-1/3 md:w-1/2 w-full px-4">
							...
							<div className="flex flex-col justify-center items-center md:items-start gap-2 mb-10 text-sm text-customWhite">
